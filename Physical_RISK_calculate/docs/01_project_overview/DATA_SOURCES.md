...
| **TXx** | 연간 최고기온 | °C | 극한 고온 |
| **TNn** | 연간 최저기온 | °C | 극한 한파 |
| **SU25** | 폭염일수 (일최고 ≥25°C) | 일 | 극한 고온 |
| **TR25** | 열대야일수 (일최저 ≥25°C) | 일 | 극한 고온 |
| **FD0** | 결빙일수 (일최저 <0°C) | 일 | 극한 한파 |
| **ID0** | 얼음일수 (일최고 <0°C) | 일 | 극한 한파 |
| **WSDIx** | 폭염 지속일수 (6일 이상) | 일 | 극한 고온 |
| **CSDIx** | 한파 지속일수 (6일 이상) | 일 | 극한 한파 |
...
| 내륙 홍수 | KMA SSP + 재난 API + DEM | - | 100% |
| 도시 홍수 | KMA SSP + 토지피복도 | - | 100% |
| 해안 홍수 | Haversine 거리 | - | 100% |
