...
### 난방 인프라 취약성 평가 (한파 리스크)

- **목적**: 지역난방 의존도 및 인프라 취약성 평가
- **활용 방법**:
  1. 사업장 위치의 지사ID 확인
  2. 겨울철 평균 난방지수 산출
  3. 난방지수가 높을수록 → 지역난방 의존도 높음 → 한파 시 난방 중단 리스크 증가

### 계산 지표

- **평균 난방지수**: 일반적인 난방 부하 수준
- **최대 난방지수**: 피크 부하 (극한 한파 시)
...
이 API는 **Extreme Cold (한파)** 리스크의 **V(Vulnerability)** 계산에 활용됩니다.

- **높은 난방지수** → 지역난방 의존도 높음 → 한파 시 취약성 증가
