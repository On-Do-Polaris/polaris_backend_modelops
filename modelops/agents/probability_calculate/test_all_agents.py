...
def main():
    ...
    success, aal = test_agent(SeaLevelRiseProbabilityAgent, "SeaLevelRiseProbabilityAgent (해수면상승)")
    ...
    success, aal = test_agent(WaterStressProbabilityAgent, "WaterStressProbabilityAgent (물스트레스)")
