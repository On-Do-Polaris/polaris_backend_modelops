...
# 결과 출력
print(f"극심한 고온 리스크: {result['extreme_heat']['risk_score']:.1f}점")
...
def calculate(self, lat: float, lon: float) -> Dict:
    ...
    return {
        ...
        'river_flood': self._calculate_river_flood_hazard(lat, lon, data),
        'urban_flood': self._calculate_urban_flood_hazard(lat, lon, data),
        'sea_level_rise': self._calculate_sea_level_rise_hazard(lat, lon, data),
...
def calculate(self, hazard: Dict, exposure: Dict) -> Dict:
    ...
    return {
        ...
        'river_flood': self._calc_flood_vulnerability(
            hazard['river_flood'], exposure, 'inland'
        ),
        'urban_flood': self._calc_flood_vulnerability(
            hazard['urban_flood'], exposure, 'urban'
        ),
        'sea_level_rise': self._calc_flood_vulnerability(
            hazard['sea_level_rise'], exposure, 'coastal'
        ),
